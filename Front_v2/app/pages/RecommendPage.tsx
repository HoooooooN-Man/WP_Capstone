        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 px-5 py-3 rounded-xl bg-[var(--bg-elev-1)] border border-[var(--border)]">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span
                title={[
                  '다양화 — 추천 종목간 상관성을 낮춰 포트폴리오 위험을 분산합니다.',
                  '',
                  '• Correlation: 과거 수익률 상관계수 기반 (60일 일간수익률). 상관 높은 종목 제외.',
                  '• Sector: 동일 섹터(wics_large) 비중 cutoff. 한 섹터 집중 방지.',
                  '• Embedding: 뉴스/공시 텍스트 임베딩 코사인 유사도 기반.',
                  '• None: 다양화 미적용 — score 순으로만 TOP K.',
                  '',
                  '※ Capstone 기본값 = Correlation (sector 는 W3.5 FAIL, embedding 은 W5 음의 gain 으로 보조용)',
                ].join('\n')}
                style={{
                  display: 'inline-flex', alignItems: 'center', justifyContent: 'center',
                  width: 18, height: 18, borderRadius: '50%',
                  backgroundColor: 'var(--bg-elev-2)', color: 'var(--text-tertiary)',
                  fontSize: 11, fontWeight: 700, cursor: 'help', marginTop: 18,
                }}
              >
                ?
              </span>
